...
export const AdocaoPage: React.FC = () => {
  return (
    <Container>
      <Box sx={{paddingLeft: { xs: 2, md: "75px" }, paddingRight: { xs: 2, md: "75px" }, paddingTop: { xs: 4, md: "71px" }, paddingBottom: { xs: 4, md: 8 }}}>
        <Box>
        ...
        <Box sx={{ bgcolor: "white", marginRight: "31px", marginBottom: "79px", marginTop: "28px", display: "grid", gridTemplateColumns: { xs: "1fr", md: "repeat(3, 1fr)" }, gap: "20px", alignItems: "stretch", paddingLeft: "28px", paddingRight: "28px", paddingBottom: "34px", paddingTop: "35px", color: "blacka acade", borderRadius: "8px" }}>
            ...
            <Box sx={{ display: "grid", gridTemplateColumns: { xs: "4fr", md: "repeat(4, 1fr)" }, gap: "20px", alignItems: "stretch", paddingLeft: "28px", paddingRight: "28px", paddingBottom: "34px", paddingTop: "35px" }}>
              <CardAnimal nome="Rex" cidade="Centro" imagem="https://2.bp.blogspot.com/-07_Da0vxQuk/UPGaadF1VQI/AAAAAAAAADE/1KDhiQPNJa8/s320/Cachorro_Feliz.jpg" adotado={true} onClick={() => {}} /><CardAnimal nome="Rex" cidade="Centro" imagem="https://tse1.mm.bing.net/th/id/OIP.qUZKYeiway1yQS3pAev09wAAAA?r=0&cb=thfc1falcon&rs=1&pid=ImgDetMain&o=7&rm=3" adotado={false} onClick={() => {}} /><CardAnimal nome="Rex" cidade="Centro" imagem="https://i0.hippopx.com/photos/724/19/771/dog-labrador-pet-sitting-dog-thumb.jpg" adotado={false} onClick={() => {}} /><CardAnimal nome="Rex" cidade="Centro" imagem="https://i.ytimg.com/vi/RbYTtzubg8I/maxresdefault.jpg" adotado={false} onClick={() => {}} /><CardAnimal nome="Rex" cidade="Centro" imagem="https://2.bp.blogspot.com/-07_Da0vxQuk/UPGaadF1VQI/AAAAAAAAADE/1KDhiQPNJa8/s320/Cachorro_Feliz.jpg" adotado={false} onClick={() => {}} /><CardAnimal nome="Rex" cidade="Centro" imagem="https://2.bp.blogspot.com/-07_Da0vxQuk/UPGaadF1VQI/AAAAAAAAADE/1KDhiQPNJa8/s320/Cachorro_Feliz.jpg" adotado={false} onClick={() => {}} /><CardAnimal nome="Rex" cidade="Centro" imagem="https://2.bp.blogspot.com/-07_Da0vxQuk/UPGaadF1VQI/AAAAAAAAADE/1KDhiQPNJa8/s320/Cachorro_Feliz.jpg" adotado={false} onClick={() => {}} /><CardAnimal nome="Rex" cidade="Centro" imagem="https://2.bp.blogspot.com/-07_Da0vxQuk/UPGaadF1VQI/AAAAAAAAADE/1KDhiQPNJa8/s320/Cachorro_Feliz.jpg" adotado={false} onClick={() => {}} /><CardAnimal nome="Rex" cidade="Centro" imagem="https://2.bp.blogspot.com/-07_Da0vxQuk/UPGaadF1VQI/AAAAAAAAADE/1KDhiQPNJa8/s320/Cachorro_Feliz.jpg" adotado={false} onClick={() => {}} /><CardAnimal nome="Rex" cidade="Centro" imagem="https://2.bp.blogspot.com/-07_Da0vxQuk/UPGaadF1VQI/AAAAAAAAADE/1KDhiQPNJa8/s320/Cachorro_Feliz.jpg" adotado={false} onClick={() => {}} /><CardAnimal nome="Rex" cidade="Centro" imagem="https://2.bp.blogspot.com/-07_Da0vxQuk/UPGaadF1VQI/AAAAAAAAADE/1KDhiQPNJa8/s320/Cachorro_Feliz.jpg" adotado={false} onClick={() => {}} /><CardAnimal nome="Rex" cidade="Centro" imagem="https://2.bp.blogspot.com/-07_Da0vxQuk/UPGaadF1VQI/AAAAAAAAADE/1KDhiQPNJa8/s320/Cachorro_Feliz.jpg" adotado={false} onClick={() => {}} />
