  ...
  return (
    <Container>
      <Box sx={{paddingLeft: { xs: 2, md: "51px" }, paddingRight: { xs: 2, md: "51px" }, paddingTop: { xs: 4, md: "71px" }, paddingBottom: { xs: 4, md: 8 }}}>
        ...
        <Box sx={{ bgcolor: "white", marginBottom: "79px", marginTop: "28px", display: "grid", gridTemplateColumns: { xs: "1fr", md: "repeat(3, 1fr)" }, gap: "20px", alignItems: "stretch", paddingLeft: "28px", paddingRight: "28px", paddingBottom: "34px", paddingTop: "35px", color: "blacka acade", borderRadius: "8px" }}>
